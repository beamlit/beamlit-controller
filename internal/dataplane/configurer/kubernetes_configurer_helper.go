...
func (s *kubernetesConfigurer) mirrorEndpointSlices(ctx context.Context, serviceRef *modelv1alpha1.ServiceReference, targetPort int32) error {
...
func (s *kubernetesConfigurer) watchService(ctx context.Context, serviceRef *modelv1alpha1.ServiceReference) error {
